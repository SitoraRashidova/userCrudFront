...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 p-6">
      <h2 className="text-4xl font-bold text-gray-200 mb-6">Hero</h2>

      <div className="space-x-4">
        <button
          onClick={() => dispatch(inc(1))}
          className="bg-blue-50 text-white px-6 py-3 rounded-md hover:bg-blue-600 transition duration-300"
        >
          Increment-1
        </button>
        <button
